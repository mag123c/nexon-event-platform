import { RewardType } from '../../domain/reward/value-objects/reward-type.vo';
import { Injectable } from '@nestjs/common';
import {
  InvalidRewardDetailsException,
  UnsupportedRewardTypeException,
} from '@app/event/domain/reward/errors/reward.exception';
import { ItemRewardDetails } from '@app/event/domain/reward/entities/reward.entity';
import {
  RewardDetails,
  PointRewardDetails,
} from '@app/event/domain/reward/value-objects/reward-detail.vo';
