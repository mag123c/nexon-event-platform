...
import { UserActivityFetcher } from '@app/event/event-core/application/ports/user-activity.fetcher';
...
export class UserActivityHttpFetcher implements UserActivityFetcher {
  ...
  async fetchByUserId(userId: string): Promise<UserActivityData | null> {
